const profile = {
    ...
    title: 'Gangeshwar Krishnamurthy | Co-Founder & CTO @ MindFi.co',
    description: 'a software architect, platform engineer and a product manager interested in building software products that are delightful and scalable.',
    image: '/profile.jpg',
